						...
						<div className='flex'>
							<div className='flex justify-center items-start gap-5'>
								...
								<div className='flex flex-col justify-between items-start gap-3'>
									...
									<Link href={opening_hours} className='font-light uppercase'>Sprawdź</Link>
								</div>
							</div>
						</div>
						<div className='flex'>
							<div className='flex justify-center items-start gap-5'>
								...
								<div className='flex flex-col justify-between items-start gap-3'>
									...
									<Link href={price_list} className='font-light uppercase'>Sprawdź</Link>
								</div>
							</div>
						</div>
						<div className='flex'>
							<div className='flex justify-center items-start gap-5'>
								...
								<Link href={directions} className='font-light uppercase'>Sprawdź</Link>
								</div>
							</div>
						</div>
					</div>
