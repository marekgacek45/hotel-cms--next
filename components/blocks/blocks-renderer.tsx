...
import BlockAttractionsHotelGrid from "./block-attractions-hotel"
	...
	return (
		<>
			{blocks.map((block, index) => {
				...
				if (block.collection === 'block_attractions_hotel_grid') {
					

					return <BlockAttractionsHotelGrid  key={block.item.id} {...block.item}  />
				}
