...
import AttractionCard from '@/components/cards/attractions-hotel'
import directus from '@/lib/directus'
import { readItems } from '@directus/sdk'

const BlockAttractionsHotelGrid = async ({ listing_type, grid_columns }) => {
	const gridColumns = (() => {
		switch (grid_columns) {
			case 2:
...
export default BlockAttractionsHotelGrid
